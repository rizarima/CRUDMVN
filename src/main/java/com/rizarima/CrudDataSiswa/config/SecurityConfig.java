 ...
 */
package com.rizarima.CrudDataSiswa.config;
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth)
        throws Exception{
            ...
            protected void configure(HttpSecurity http) throws Exception {
                http
                        .authorizeRequests()
                            .antMatchers(HttpMethod.GET,"/api/siswa/**").hasRole("SISWA_VIEW")
                            .antMatchers(HttpMethod.POST,"/api/siswa/**").hasRole("SISWA_CREATE")
                            .antMatchers(HttpMethod.DELETE,"/api/siswa/**").hasRole("SISWA_DELETE")
                            .antMatchers(HttpMethod.PUT,"/api/siswa/**").hasRole("SISWA_UPDATE")
